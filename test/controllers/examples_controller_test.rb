...
class ExamplesControllerTest < ActionController::TestCase
  ...
  test "should create example" do
    assert_difference('Example.count') do
      post :create, example: { desc: @example.desc, integer: @example.integer, name: @example.name, string: @example.string }
    end
  ...
  test "should update example" do
    patch :update, id: @example, example: { desc: @example.desc, integer: @example.integer, name: @example.name, string: @example.string }
    assert_redirected_to example_path(assigns(:example))
  end
